...
import { FaceItem, PersonItem } from 'src/types';
...
export function mapPerson(person: PersonItem): PersonResponseDto {
  return {
    id: person.id,
    name: person.name,
...
export function mapFaces(face: FaceItem, auth: AuthDto): AssetFaceResponseDto {
  return {
    id: face.id,
    imageHeight: face.imageHeight,
    imageWidth: face.imageWidth,
